...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush }, isPushed ? (React.createElement(Icon$P, { width: "24px", color: "#FFFFFF" })) : (React.createElement(Icon$O, { width: "24px", color: "#FFFFFF" }))),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#0f0e2e", backgroundDisabled: "#E9EAEB", contrast: "#0f0e2e", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputBorder: "#cccccc", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#FFFFFF", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#FFFFFF", background: "#0f0e2e", backgroundDisabled: "#3c3742", contrast: "#102648", invertedContrast: "#0a0e17", input: "#483f3b", inputBorder: "#cccccc", primaryDark: "#FFFFFF", tertiary: "#2d2f37", text: "#FFFFFF", textDisabled: "#666171", textSubtle: "#33E7FF", borderColor: "#524B63", card: "#102648", gradients: {
